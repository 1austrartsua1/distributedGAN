...
from optim.OptimFBF import FBFAdam
...
def main_worker(global_rank, local_rank, world_size, netG, netD,
    ...
    optimizerD = FBFAdam(netD.parameters(), lr=lr_dis, betas=(beta1, beta2))
    optimizerG = FBFAdam(netG.parameters(), lr=lr_gen, betas=(beta1, beta2))
